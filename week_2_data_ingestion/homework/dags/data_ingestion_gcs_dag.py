...
INPUT_DATA_PATH = AIRFLOW_HOME + '/input_data'
...
YELLOW_TAXI_PARQUET_FILE_TEMPLATE = INPUT_DATA_PATH + '/yellow_tripdata_{{ execution_date.strftime(\'%Y-%m\') }}.parquet'
...
FHV_TAXI_PARQUET_FILE_TEMPLATE =  INPUT_DATA_PATH + '/fhv_tripdata_{{ execution_date.strftime(\'%Y-%m\') }}.parquet'
